...
nil is covered in nil.rb, etc. They are presented in order in the missions.rb file.

Each mission builds up your knowledge of Ruby and builds upon itself.  It will stop at
...
If you do not have Ruby setup, please visit http://www.lua.org/download.html for
...
*nix platforms, from the lua_missions root directory:

    [lua_missions] $ lua missions.lua

Windows is the same thing

    c:\lua_missions\lua missions.lua                             # runs the default target :walk_the_path
...
The very first time you run it you will see the following output:
    ...
    Starting mission 'asserts'
      test_assert is failing.

    You still have missions to do ...
    <false> is not true.

    The error happened here:
      ./missions/asserts.lua:3: in function <./missions/asserts.lua:2>
      missions.lua:21: in main chunk


You have come to your first stage. It is telling you where to look for the first solution:
